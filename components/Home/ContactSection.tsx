   ...
   return (
      <Container className="max-w-4xl mb-4" id="contact">
         <div className="absolute flex items-center top-[60%] lg:top-inherit gap-4 right-0 lg:left-0 ">
            ...
            <div
               className={clsx(
                  "flex flex-col text-tiny text-gray-300 md:text-sm w-40",
                  fontFira.className
               )}
            >
               <h3>Practice Make </h3>
         ...
         <div className="pl-10 lg:pl-40 text-start">
            <article className="flex flex-col gap-10">
               <h2 className={clsx("text-3xl md:text-4xl leading-tight", fontFira.className)}>
                  {text.map((el, i) => (
                     <motion.span
                        key={i}
               ...
               <p className={clsx(fontMono.className, "pr-2")}>
                  Don’t miss out on aesthetic UI and industry standard functionalities. Let&apos;s
         ...
         <Slide triggerByButton className="mt-[5rem]" delay={0} direction="down" trigger={open}>
