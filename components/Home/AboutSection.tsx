...
function AboutSection() {
   return (
      <Container className="" id="about">
         <div className="absolute top-0 left-0 mt-[4.5rem] right-0 bottom-0 bg-gradient-to-t from-background from-10% via-transparent via-90% z-30" />
         <div className="flex left-0 z-10 absolute gap-10 top-0 mt-[4.5rem]">
            ...
            >
               <motion.path
                  ...
                  initial={{ pathLength: 0.001, stroke: "rgba(48, 238, 226, 0)" }}
                  stroke="transparent"
                  strokeLinecap="round"
                  strokeWidth="4"
                  transition={{
